...
${evidence}
		...
		function createBugKillerButton(connection) {
			return function BugKillerButton(props) {
				...
				const statusLive = stored.stage === "instrumenting" || stored.stage === "checkingLog" || stored.stage === "settlingLogs" || stored.stage === "fixing";
				...
				}, h("span", { className: `dbk-dot${statusLive ? " dbk-dot-live" : ""}` }), h("span", null, `Bug Killer${statusLabel === "" ? "" : ` · ${statusLabel}`}`));
		...
		function isStoredState(value) {
			...
			return typeof candidate.issue === "string" && typeof candidate.projectPath === "string" && typeof candidate.logPath === "string" && typeof candidate.traceId === "string" && (candidate.stage === "setup" || candidate.stage === "instrumenting" || candidate.stage === "restartRequired" || candidate.stage === "checkingLog" || candidate.stage === "capturing" || candidate.stage === "settlingLogs" || candidate.stage === "noIssue" || candidate.stage === "fixing" || candidate.stage === "complete" || candidate.stage === "failed") && (candidate.failedTask === void 0 || candidate.failedTask === "instrumentation" || candidate.failedTask === "diagnosis") && (candidate.startedAt === void 0 || typeof candidate.startedAt === "number") && (candidate.captureStartOffset === void 0 || typeof candidate.captureStartOffset === "number");
		}
